...
class GameSqlRepository(GameRepository):
    ...
    def get(self, game_id: str) -> Game:
        ...
        game = Game(turn_order=players, deck=deck, game_status=gamedb.status, turn_position=gamedb.turn_position, game_id=gamedb.id)
        return game
    ...
    def save(self, game: Game) -> Game:
        with Session(self.engine) as session:
            ...
            db_game = DbGame(
                status=game.game_status, turn_position=game.turn_position, players=players, cards=deck
            )
    ...
    def update(self, game: Game):
        ...
        game_db.status = game.game_status
